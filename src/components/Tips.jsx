  ...
  return (
    <div className='m-5'>
        <div className="max-w-6xl mx-auto flex flex-wrap md:p-3 lg:p-0 relative">
          ...
          <div className="w-full lg:w-1/2 mt-5 p-5 lg:border-l-4 border-pink-300 relative md:pl-9 pl-0 lg:mt-14">
            <h1 className="mt-10 text-3xl md:text-5xl font-bold text-gray-500 ">Tips de Repostería</h1>
          </div>
        </div>
    </div>
  )
